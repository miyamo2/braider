...
func TestInjectDetector_NilMarkers(t *testing.T) {
	annotationPkg := createAnnotationPackage()
	...
	tests := []struct {
		...
		{
			name: "has Injectable embedding but nil markers returns false",
			src: `package test
...
`,
		...
		{
			name: "no annotation returns false",
			src: `package test
...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			detector := detect.NewInjectDetector(nil)
			if detector.HasInjectAnnotation(pass, structType) {
				t.Error("HasInjectAnnotation() = true, want false with nil markers")
			}
		})
	}
}

func TestInjectDetector_NilInjectableMarkerField(t *testing.T) {
	annotationPkg := createAnnotationPackage()
	...
	tests := []struct {
		...
		{
			name: "has Injectable embedding but nil Injectable marker field returns false",
			src: `package test
...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			detector := detect.NewInjectDetector(&detect.MarkerInterfaces{})
			if detector.HasInjectAnnotation(pass, structType) {
				t.Error("HasInjectAnnotation() = true, want false with nil Injectable marker field")
			}
		})
	}
}
