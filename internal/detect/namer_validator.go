...
type namerValidatorImpl struct {
	annotation.Injectable[inject.Typed[NamerValidator]]
	loader loader.PackageLoader
}

// NewnamerValidatorImpl is a constructor for namerValidatorImpl.
//
// Generated by braider. DO NOT EDIT.
func NewnamerValidatorImpl(loader loader.PackageLoader) *namerValidatorImpl {
