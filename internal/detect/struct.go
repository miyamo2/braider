...
type structDetector struct {
	annotation.Injectable[inject.Typed[StructDetector]]
	injectDetector InjectDetector
}

// NewstructDetector is a constructor for structDetector.
//
...
func (d *structDetector) processGenDecl(
	pass *analysis.Pass, genDecl *ast.GenDecl, candidates []ConstructorCandidate,
