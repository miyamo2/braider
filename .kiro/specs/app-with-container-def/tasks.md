...
- [ ] 1. Define container data models and extend App annotation detection for the generic form
- [ ] 1.1 Define the container-related data models used throughout the pipeline
...
- [ ] 1.2 Extend the App annotation detector to handle generic `annotation.App[T](main)` calls
...
- [ ] 1.3 Add unit tests for generic App call detection
...
- [ ] 2. Implement the App option extractor to classify App type parameters
- [ ] 2.1 (P) Implement the App option extractor component
...
- [ ] 2.2 (P) Add unit tests for the App option extractor
...
- [ ] 3. Implement container struct validation
- [ ] 3.1 (P) Implement the container validator component
...
- [ ] 3.2 (P) Add unit tests for the container validator
...
- [ ] 4. Implement container field resolution
- [ ] 4.1 (P) Implement the container resolver component
...
- [ ] 4.2 (P) Add unit tests for the container resolver
...
- [ ] 5. Extend container-specific diagnostics
- [ ] 5.1 (P) Add container-specific diagnostic emission methods
...
- [ ] 5.2 (P) Add unit tests for container diagnostic emission
...
- [ ] 6. Extend hash computation to include container field definitions
- [ ] 6.1 (P) Extend the graph hash computation to incorporate container struct metadata
...
- [ ] 6.2 (P) Add unit tests for extended hash computation
...
- [ ] 7. Extend import collection for container types
- [ ] 7.1 (P) Extend the import collector to include container type and field type packages
...
- [ ] 7.2 (P) Add unit tests for container import collection
...
- [ ] 8. Implement container-aware bootstrap code generation
- [ ] 8.1 Implement the container bootstrap generation method
...
- [ ] 8.2 Implement the container-aware idempotency check method
...
- [ ] 8.3 Add unit tests for container bootstrap generation
...
- [ ] 9. Extend the App analyzer orchestration to support the container pipeline
- [ ] 9.1 Wire new components into the App analyzer runner
...
- [ ] 9.2 Update braider's own DI bootstrap to wire the new components
...
- [ ] 10. Add integration tests for container bootstrap scenarios
- [ ] 10.1 Add integration test for basic named container struct
...
- [ ] 10.2 Add integration test for anonymous container struct
...
- [ ] 10.3 Add integration test for named field resolution via struct tag
...
- [ ] 10.4 Add integration test for interface-typed container field
...
- [ ] 10.5 Add integration test for cross-package container struct
...
- [ ] 10.6 Add integration test for transitive dependencies
...
- [ ] 10.7 Add integration test for container with Variable dependencies
...
- [ ] 10.8 Add integration test for container idempotent regeneration
...
- [ ] 10.9 Add integration test for container outdated regeneration
...
- [ ] 10.10 Add integration test for mixed options via anonymous interface embedding
...
- [ ] 11. Add integration tests for container error scenarios
- [ ] 11.1 (P) Add integration test for non-struct container type parameter
...
- [ ] 11.2 (P) Add integration test for unresolved container field
...
- [ ] 11.3 (P) Add integration test for ambiguous container field
...
- [ ] 11.4 (P) Add integration test for forbidden `braider:"-"` struct tag
  - Create a testdata case where a container field has `braider:"-"` and verify a diagnostic error is emitted
  - _Requirements: 2.5, 6.5_

- [ ] 11.5 (P) Add integration test for empty `braider:""` struct tag
  - Create a testdata case where a container field has `braider:""` and verify a diagnostic error is emitted
  - _Requirements: 2.6, 6.5_

- [ ] 12. Verify full build and test suite pass
