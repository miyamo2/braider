...
- [x] 2. Add diagnostic emission methods for struct tag errors
- [x] 2.1 (P) Add an invalid struct tag diagnostic method to the diagnostic emitter
...
- [x] 2.2 (P) Add a struct tag conflict diagnostic method to the diagnostic emitter
...
- [x] 2.3 Add unit tests for the new diagnostic methods
...
- [x] 3. Update DependencyAnalyzeRunner Phase 1 for tag-aware constructor generation
- [x] 3.1 Filter excluded fields and build the named dependency map before constructor generation
...
- [x] 3.2 Switch constructor generation to the tag-aware path
...
- [x] 3.3 Add unit tests for Phase 1 tag-aware constructor generation
...
- [x]4. Update DependencyAnalyzeRunner Phase 3 for tag-aware registry registration
- [x]4.1 Construct composite dependency keys for named fields during registration
...
- [x]4.2 Implement WithoutConstructor conflict validation
...
- [x]4.3 Add unit tests for Phase 3 tag-aware registration and validation
...
- [x]5. Add integration tests for constructor generation with struct tags
- [x]5.1 (P) Add a constructorgen test case for named dependency via struct tag
...
- [x]5.2 (P) Add a constructorgen test case for field exclusion via struct tag
...
- [x]6. Add integration tests for bootstrap generation with struct tags
- [x]6.1 Add a bootstrapgen test case for named dependency wiring
...
- [x]6.2 Add a bootstrapgen test case for field exclusion in bootstrap
...
- [x]6.3 Add a bootstrapgen test case for mixed struct tags
...
- [x]6.4 Add a bootstrapgen test case for all fields excluded
...
- [x]6.5 Add a bootstrapgen error test case for empty struct tag
...
- [x]6.6 Add a bootstrapgen error test case for WithoutConstructor conflict
...
- [x]7. Add integration tests for idempotent behavior with struct tags
- [x]7.1 (P) Add an idempotent test case for struct tag stability
...
- [x]7.2 (P) Add an outdated test case for struct tag changes
...
- [x]8. Validate type compatibility and cross-cutting requirements
- [x]8.1 (P) Add a bootstrapgen test case exercising all supported field types with named tags
...
- [x]8.2 Verify hash computation captures struct tag changes through dependency list differences
