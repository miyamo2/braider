---
applyTo: "internal/analyzer/integration_test.go,internal/analyzer/testdata/**"
---
...
- Internal structure of the analyzer pipeline under test → see `architecture.instructions.md`
- Rules governing how the generated code that appears in golden files is built → see `code-generation.instructions.md`
- Annotation / struct-tag specifications exercised by the test cases → see `annotations.instructions.md` / `struct-tags.instructions.md`
